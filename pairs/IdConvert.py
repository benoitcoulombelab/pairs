...
def main(argv: list[str] = None):
    ...
    id_convert(input_file=args.input, output_file=args.output, mapping_file=args.mapping,
               id_column=args.id_column - 1, mapping_source_column=args.source_column - 1,
               mapping_converted_column=args.converted_column - 1)


def id_convert(input_file: TextIO, output_file: TextIO, mapping_file: TextIO, id_column: int = 0,
