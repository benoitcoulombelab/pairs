...
def main(argv: list[str] = None):
  parser = argparse.ArgumentParser(
      description="Creates a FASTA file per sequence found in input FASTA file.")
...
def split_fasta(fasta: TextIO, output_dir: str):
  ...
  for sequence_id in sequences:
    SeqIO.write(sequences[sequence_id],
                os.path.join(output_dir, f"{sequence_id}.fasta"), "fasta")
